...
const Sidebar = () => {
            ...
            >
                {({ isActive }) => (
                    <>
                        ...
                        <span className={`text-sm font-semibold whitespace-nowrap transition-all duration-300 ${isCollapsed ? 'lg:opacity-0 lg:w-0 lg:translate-x-4' : 'opacity-100 w-auto translator-x-0'}`}>Main</span>
                    </>
                )}
            </NavLink>
            ...
            >
                {({ isActive }) => (
                    <>
                        ...
                        <span className={`text-sm font-medium whitespace-nowrap transition-all duration-300 ${isCollapsed ? 'lg:opacity-0 lg:w-0 lg:translate-x-4' : 'opacity-100 w-auto translator-x-0'}`}>Adv. Config</span>
                    </>
                )}
            </NavLink>
            ...
            >
                {({ isActive }) => (
                    <>
                        ...
                        <span className={`text-sm font-medium whitespace-nowrap transition-all duration-300 ${isCollapsed ? 'lg:opacity-0 lg:w-0 lg:translate-x-4' : 'opacity-100 w-auto translator-x-0'}`}>Leaderboard</span>
                    </>
                )}
            </NavLink>
            ...
            >
                {({ isActive }) => (
                    <>
                        ...
                        <span className={`text-sm font-medium whitespace-nowrap transition-all duration-300 ${isCollapsed ? 'lg:opacity-0 lg:w-0 lg:translate-x-4' : 'opacity-100 w-auto translator-x-0'}`}>Profile</span>
                    </>
                )}
            </NavLink>
        </>
    ...
    return (
        <>
            <div className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-surface-dark border-b border-border-dark flex items-center justify-between px-4 z-50">
                    ...
                    <div className="mt-auto pb-10">
                        {user ? (
                            ...
                            <a
                                ...
                                className="w-full bg-primary hover:bg-primary-dim text-black font-bold uppercase tracking-widest py-4 rounded-xl transition-all text-sm flex items-center justify-center gap-2"
                            >
            ...
            <aside
                id="sidebar"
                className={`hidden lg:flex bg-surface-dark border-r border-border-dark flex-shrink-0 flex flex-col justify-between transition-all duration-300 ease-in-out relative z-20 ${isCollapsed ? 'w-20' : 'w-72'}`}
            >
                <div>
                ...
                <div className="p-4 border-t border-border-dark flex flex-col gap-4">
                    {user ? (
                        <>
                            <div className={`flex items-center gap-3 transition-all duration-300 ${isCollapsed ? 'justify-center border-b border-zinc-800/50 pb-4' : ''}`}>

        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-6 lg:p-8 space-y-8">
            ...
            <div className="bg-surface-dark border border-border-dark rounded-lg p-6 flex flex-col md:flex-row items-center gap-6">
                <div className="relative">
                    ...
                    />
                    <div className="absolute bottom-0 right-0 w-6 h-6 bg-green-500 rounded-full border-4 border-surface-dark" title="Online"></div>
                </div>
                <div className="text-center md:text-left flex-1">
                    <h1 className="font-display text-3xl font-bold text-white mb-1">{user.username}</h1>
                    <p className="text-zinc-500 text-sm font-medium uppercase tracking-wider">Controller</p>
